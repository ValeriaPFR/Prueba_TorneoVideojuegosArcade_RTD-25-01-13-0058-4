...
Este programa en Python permite administrar de forma completa un torneo de videojuegos clásicos en el arcade **Pixeles Retro**. ]El sistema gestiona la inscripción de jugadores, la creación de parejas competitivas , el registro de los partidos y la generación automática de estadísticas de rendimiento y tablas de posiciones

Proyecto desarrollado para la evaluación final del módulo de **Fundamentos de Ciencias de Datos**.

---

## 🛠️ Características Principales

* **Control de Inscripciones:** Registro de participantes con validación en tiempo real.
...
* **Formación de Parejas:** Creación de equipos de 2 jugadores asegurando nombres únicos y control de duplicados (un jugador no puede estar en dos equipos a la vez)
* **Módulo de Partidas:** Registro de enfrentamientos asignando 3 puntos reglamentarios al equipo ganador.
* **Analítica de Datos:** Uso del módulo nativo `statistics` de Python para calcular promedios, medianas, modas y variabilidad de los puntajes del torneo
...
* **Equivocación C (Edad fuera de rango):** Si ingresas una edad menor a 12 o mayor a 70 años.
  * *Mensaje en terminal:* `❌ Lo siento, la edad debe estar entre los 12 y los 70 años para participar.`
* **Equivocación D (Tipo de dato inválido en edad o nivel):** Si por error escribes letras en lugar de números enteros.
  * *Mensaje en terminal:* `❌ Por favor, ingresa la edad usando solo números enteros.`

### 2. Validación al Formar Equipos
* **Equivocación A (Falta de jugadores):** Si intentas armar una pareja pero no hay al menos 2 personas registradas y libres en el sistema.
  * *Mensaje en terminal:* `❌ No hay suficientes jugadores libres para armar un equipo.`
* **Equivocación B (Nombre de equipo duplicado):** Si intentas usar un nombre que otra pareja ya registró.
